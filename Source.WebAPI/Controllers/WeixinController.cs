...
namespace Source.WebAPI.Controllers
{
    ...
    using Source.Payment.CustomMessageHandler;
    using Source.Payment.Utilities;
    using System.Text;
    ...
    public partial class WeixinController : Controller
    {
        ...
        public async Task<ActionResult> MultiAccountTest()
        {
            ...
            var setting1 = Senparc.Weixin.Config.SenparcWeixinSetting.Items["Default"];
            var setting2 = Senparc.Weixin.Config.SenparcWeixinSetting.Items["第二个公众号"];

            var sb = new StringBuilder();

            //获取一轮AccessToken
            var token1_1 = await Senparc.Weixin.MP.Containers.AccessTokenContainer.GetAccessTokenResultAsync(setting1.WeixinAppId, true);
            var token2_1 = await Senparc.Weixin.MP.Containers.AccessTokenContainer.GetAccessTokenResultAsync(setting2.WeixinAppId, true);
            ...
            //重新获取一轮
            var token1_2 = await Senparc.Weixin.MP.Containers.AccessTokenContainer.GetAccessTokenResultAsync(setting1.WeixinAppId, true);
            var token2_2 = await Senparc.Weixin.MP.Containers.AccessTokenContainer.GetAccessTokenResultAsync(setting2.WeixinAppId, true);
            ...
            //使用高级接口返回消息
            var result1 = await Senparc.Weixin.MP.AdvancedAPIs.UrlApi.ShortUrlAsync(setting1.WeixinAppId, "long2short", "https://sdk.weixin.senparc.com");
            var result2 = await Senparc.Weixin.MP.AdvancedAPIs.UrlApi.ShortUrlAsync(setting2.WeixinAppId, "long2short", "https://weixin.senparc.com");
